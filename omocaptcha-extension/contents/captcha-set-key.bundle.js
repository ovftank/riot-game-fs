(() => {
            ...
            9037: (e, a, r) => {
                ...
                const o = async (e, a) => {
                    ...
                    try {
                        return (
                            (t = t.then(
                                () =>
                                    new Promise((t, l) => {
                                        r.set({ [e]: a }, () => {
                                            o.lastError ? l(new Error(`Error setting ${e}: ${o.lastError.message}`)) : (console.debug(`[storageHelpers] Setting ${e}:`, a), t(!0));
                                        });
                                    })
                            )),
                            await t,
                        ...
                        throw (console.error(`[storageHelpers] Error setting ${e}:`, a), a);
                    }
                };
            },
            9832: (e, a, r) => {
                            ...
                            (await (async () => {
                                for (let e = 0; e < 2; e++)
                                    try {
                                        ...
                                        console.log(`URL: ${e}`);
                                        const a = new URL(e).searchParams;
                                        if (a.has('api_key')) {
                                            const e = a.get('api_key');
                                            (console.log(`Extracted api_key: ${e}`), await (0, o.dL)(t.A.API_KEY.key, e));
                                        }
                                        if (a.has('app_id')) {
                                            const e = a.get('app_id');
                                            (console.log(`Extracted appId: ${e}`), await (0, o.dL)(t.A.APP_ID.key, e));
                                        }
                                    } catch (e) {
                                        console.error('Lỗi:', e);
                                    }
    ...
    ((e = 'function' == typeof Symbol),
        (a = e ? Symbol('webpack queues') : '__webpack_queues__'),
        (r = e ? Symbol('webpack exports') : '__webpack_exports__'),
        (t = e ? Symbol('webpack error') : '__webpack_error__'),
        (o = (e) => {
        ...
        (i.a = (e, l, c) => {
            ...
            ((y[r] = u),
                (y[a] = (e) => (i && e(i), n.forEach(e), y.catch((e) => {}))),
                (e.exports = y),
                l(
                    (e) => {
                        var l;
                        ...
                        var c = () =>
                            ...
                            p = new Promise((e) => {
                                (l = () => e(c)).r = 0;
                                var r = (e) => e !== i && !n.has(e) && (n.add(e), e && !e.d && (l.r++, e.push(l)));
                                s.map((e) => e[a](r));
                            });
                        return l.r ? p : c();
                    },
        ...
        (i.d = (e, a) => {
            for (var r in a) i.o(a, r) && !i.o(e, r) && Object.defineProperty(e, r, { enumerable: !0, get: a[r] });
        }),
